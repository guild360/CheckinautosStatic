var WpFcStatics = {
	...
	country_code: "",
	lang_code: "",
	init: function(ajax_url, plugin_dir_url, country_code, lang_code){
	...
	wpfc_get_servers: function(){
		...
		var servers = {
					   ...
					   "euw": [
					   		   ...
					   		   {"key": "fr", "time":0,"flag":"de","location":"France","color":"red", "url":"https://fr.wpfastestcache.com"},
					   	...
					   	"eue": [
					   		   {"key": "at", "time":0,"flag":"de","location":"AT","color":"red", "url":"https://at.wpfastestcache.com"},
							   {"key": "pl", "time":0,"flag":"de","location":"Poland","color":"red", "url":"https://pl.wpfastestcache.com"},
							   {"key": "cz", "time":0,"flag":"de","location":"Czech Republic","color":"red", "url":"https://cz.wpfastestcache.com"},
		...
		if(self.country_code){
			...
			if(typeof self.lang_code != "undefined" && self.lang_code == "ru_RU"){
				self.wpfc_get_server_time(servers.eue);
				self.wpfc_get_server_time(servers.as);
			}else if(typeof self.lang_code != "undefined" && self.lang_code == "zh_CN"){
				self.wpfc_get_server_time(servers.as);
			}else{
				setTimeout(function(){
